...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ziy5p1m.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ziy5p1m.containers.anotherwebservice.com/
...
```
git clone git@github.com:mohdtalib20/container-ziy5p1m.git
cd container-ziy5p1m
```
...
```
docker attach container-ziy5p1m
```
